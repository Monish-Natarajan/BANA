...
run_id = "25nc83cq"
wandb.init(id = run_id, project="BANA", name="Stage1_COCO_to_COCO",resume='must')
...
def main(cfg):
    ...
    if(first_run==True):
      ...
      wandb_checkpoint = wandb.restore("checkpoint_30000.pt",run_path=f"monish/BANA/{run_id}")
    ...
    torch.save({
            ...
            'loss': storages["CE"],
            }, "/kaggle/working/checkpoint_50000.pt")
    
    wandb.save("/kaggle/working/checkpoint_50000.pt")
    wandb.finish()
