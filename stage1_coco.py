...
def main(cfg):
    ...
    if(first_run==True):
      ...
      wandb_checkpoint = wandb.restore("checkpoint_11000.pt",run_path=f"monish/BANA/{run_id}")
    ...
    torch.save({
            ...
            'loss': storages["CE"],
            }, "/kaggle/working/checkpoint_30000.pt")
    
    wandb.save("/kaggle/working/checkpoint_30000.pt")
    wandb.finish()
